...
def atualizar_dados_canvas(canvas,resultados):
    ...
    for i, dado in enumerate(resultados[:3]):  # Limita a três resultados
        ...
        if i == 0:
            preencher_encomenda1(nome, data_entrega, data_retirada, bloco, apartamento, Id, porteiro,nome_de_quem_retirou)
        elif i == 1:
            preencher_encomenda2(nome, data_entrega, data_retirada, bloco, apartamento, Id, porteiro,nome_de_quem_retirou)
        elif i == 2:
            preencher_encomenda3(nome, data_entrega, data_retirada, bloco, apartamento, Id, porteiro,nome_de_quem_retirou)

def preencher_encomenda1(nome, data_entrega, data_retirada, bloco, apartamento, Id, porteiro,nome_de_quem_retirou):
    criar_elemetos_encomenda1()
...
def preencher_encomenda2(nome, data_entrega, data_retirada, bloco, apartamento, Id, porteiro,nome_de_quem_retirou):
    criar_elemetos_encomenda2()
...
def preencher_encomenda3(nome, data_entrega, data_retirada, bloco, apartamento, Id, porteiro,nome_de_quem_retirou):
    criar_elemetos_encomenda3()
...
def criar_elemetos_encomenda1():
    canvas.create_text( 72.0, 127.0, anchor="nw", text="nome", fill="#545454", font=("BeVietnamPro Medium", 11 * -1) ,tags="dinamico")
    canvas.create_text( 72.0, 217.0, anchor="nw", text="Unidade Vinculada", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 274.0, 166.0, anchor="nw", text="data da entrega", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 274.0, 213.0, anchor="nw", text="data da retirada", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 72.0,171.0,anchor="nw", text="quem retirou", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 276.0, 127.0, anchor="nw", text="porteiro", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 72.0, 228.0, anchor="nw", text="bloco ", fill="#000000", font=("BeVietnamPro Medium", 14 * -1),tags="dinamico")
    canvas.create_text( 126.0, 228.0, anchor="nw", text="apto", fill="#000000", font=("BeVietnamPro Medium", 14 * -1),tags="dinamico")
    global image_image_1
    image_image_1 = PhotoImage( file=relative_to_assets("image_1.png"))
    image_1 = canvas.create_image( 292.0, 189.0, image=image_image_1,tags="dinamico")
...
def criar_elemetos_encomenda2():
    canvas.create_text( 72.0, 286.0, anchor="nw", text="nome", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 72.0, 376.0, anchor="nw", text="Unidade Vinculada", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 274.0, 325.0, anchor="nw", text="data da entrega", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 274.0, 372.0, anchor="nw", text="data da retirada", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 72.0, 330.0, anchor="nw", text="quem retirou", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 276.0, 286.0, anchor="nw", text="porteiro", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 72.0, 387.0, anchor="nw", text="bloco ", fill="#000000", font=("BeVietnamPro Medium", 14 * -1),tags="dinamico")
    canvas.create_text( 126.0, 387.0, anchor="nw", text="apto", fill="#000000", font=("BeVietnamPro Medium", 14 * -1),tags="dinamico")
    global image_image_2
    image_image_2 = PhotoImage( file=relative_to_assets("image_2.png"))
    image_2 = canvas.create_image( 292.0, 348.0, image=image_image_2,tags="dinamico")
...
def criar_elemetos_encomenda3():
    canvas.create_text( 72.0, 445.0, anchor="nw", text="nome", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 72.0, 535.0, anchor="nw", text="Unidade Vinculada", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 274.0, 484.0, anchor="nw", text="data da entrega", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 274.0, 531.0, anchor="nw", text="data da retirada", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 72.0, 489.0, anchor="nw", text="quem retirou", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 276.0, 445.0, anchor="nw", text="porteiro", fill="#545454", font=("BeVietnamPro Medium", 11 * -1),tags="dinamico")
    canvas.create_text( 72.0, 546.0, anchor="nw", text="bloco ", fill="#000000", font=("BeVietnamPro Medium", 14 * -1),tags="dinamico")
    canvas.create_text( 126.0, 546.0, anchor="nw", text="apto", fill="#000000", font=("BeVietnamPro Medium", 14 * -1),tags="dinamico")
    global image_image_3
    image_image_3 = PhotoImage(file=relative_to_assets("image_3.png"))
    image_3 = canvas.create_image( 292.0, 507.0, image=image_image_3,tags="dinamico")
